class person1 {
    ...
    constructor(name: string, age: number, city: string, course: string){
        this.name = name;
        this.age = age;
        this.city = city;
        this.course = course;
...
class person3 extends person1{
    constructor(name: string, age: number, city: string, cours: string){
...
// Define a  class and interface extends
